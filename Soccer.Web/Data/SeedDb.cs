...
namespace Soccer.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("1010", "Alexis", "Correa", "figo1813@gmail.com", "305 308 4342", "Calle Luna Calle Sol", UserType.Admin);
            await CheckUserAsync("2020", "Alexis", "Correa", "alexisfigo18@hotmail.com", "305 308 4342", "Calle Luna Calle Sol", UserType.User);
            await CheckUserAsync("3030", "Alexis", "Correa", "alexis.correa.cano@outlook.com", "305 308 4342", "Calle Luna Calle Sol", UserType.User);
            await CheckUserAsync("4040", "Alexis", "Correa", "alexiscorrea231191@correo.itm.edu.co", "350 634 2747", "Calle Luna Calle Sol", UserType.User);
